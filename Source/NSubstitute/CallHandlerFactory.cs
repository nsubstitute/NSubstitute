namespace NSubstitute
{
    public class CallHandlerFactory : ICallHandlerFactory
    {
        public ICallHandler CreateCallHandler(ISubstitutionContext substitutionContext)
        {
            ...
            return new CallHandler(new CallStack(matcher), new CallResults(matcher), new ReflectionHelper(), substitutionContext, new CallSpecificationFactory(substitutionContext));
        }
