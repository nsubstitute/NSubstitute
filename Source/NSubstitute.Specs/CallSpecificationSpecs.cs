    ...
    public class CallSpecificationSpecs
    {
        public class Concern : ConcernFor<CallSpecification>
        {
            ...
            public override void Context()
            {
                ...
                firstArg = "something";
                secondArg = 123;
                _call = new Call(_methodInfoOfCall, new object[] { firstArg, secondArg }, null, new IArgumentSpecification[0].ToList(), Call.HasNoOriginalMethod);
            }
        ...
        public class When_call_has_less_arguments_than_specified : Concern
        {
            public override void Context()
            {
                ...
                _firstArgSpec.stub(x => x.IsSatisfiedBy(firstArg)).Return(true);
                _secondArgSpec.stub(x => x.IsSatisfiedBy(secondArg)).Return(true);
                _call = new Call(_methodInfoSpecified, new object[] { firstArg }, null, new IArgumentSpecification[0].ToList(), Call.HasNoOriginalMethod);
            }
