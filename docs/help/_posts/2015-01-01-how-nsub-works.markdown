...
## [Calamities with classes](#calamities-with-classes)
...
### [Non-virtual members](#non-virtual-members)
...
### [Internal members and types](#internal-members-and-types)
...
#### [Option 2. Use a tag in the project file (works with .NET 5 and above)](#option-2-use-a-tag-in-the-project-file-works-with-net-5-and-above)
