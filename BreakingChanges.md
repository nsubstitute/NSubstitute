...
* Nullability is enabled for public api for .NET 8+. Workaround: you can disable nullability `<Nullable>disable</Nullable>` on project if you don't want to use it.
  For more info see <https://learn.microsoft.com/en-us/dotnet/csharp/nullable-references>
