...
{
    public class ReturnsForAllExtensionSpecs
    {
        public class When_setting_return_value_for_all : StaticConcern
        {
            protected IFoo _sub;
            ...
            {
                _callRouter.received(x => x.SetReturnForType(It.Is(typeof(IFoo)), It.IsAny<IReturn>()));
            }
