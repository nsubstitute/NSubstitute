...
let OUTPUT_PATH = rootDir @@ "output"
let releaseNotes = ReadFile (rootDir @@ "CHANGELOG.txt") |> ReleaseNotesHelper.parseReleaseNotes
...
Target "Version" <| fun _ ->
    ...
    CreateCSharpAssemblyInfo (rootDir @@ "src/NSubstitute/Properties/AssemblyInfo.cs")
...
Target "BuildDotNetCore" (fun _ ->
    DotNetCli.Build
      (fun p -> 
           { p with 
                Output = outputBasePath @@ "netstandard1.3" @@ "NSubstitute";
